...
class HistoryManager:
    ...
    def undo(self) -> Optional[HistoryEntry]:
        ...
        Returns a *defensive copy* of the undone HistoryEntry so that
        caller mutations to ``config_snapshot`` or ``input_files`` do not
        leak into the redo stack.
        """
    ...
    def redo(self) -> Optional[HistoryEntry]:
        ...
        Returns a *defensive copy* of the redone HistoryEntry (see
        :meth:`undo` for rationale).
        """
